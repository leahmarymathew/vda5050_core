...
TEST(ProtocolVersionTest, FromStringThrowsForUnsupportedVersion)
{
  EXPECT_THROW(ProtocolVersion::from_string("9.9.9"), std::invalid_argument);
}

// Test 3: Parsing an empty string throws.
TEST(ProtocolVersionTest, FromStringThrowsForEmptyString)
{
  EXPECT_THROW(ProtocolVersion::from_string(""), std::invalid_argument);
}
